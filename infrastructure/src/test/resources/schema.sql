CREATE TABLE point_policy (
    id                        BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '정책 ID',
    ...
    created_by_admin_id       BIGINT UNSIGNED NOT NULL                COMMENT '등록 관리자',
...
CREATE TABLE point_wallet (
    id                      BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '지갑 ID',
...
CREATE TABLE point_earning (
    id                   BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '적립 ID',
    wallet_id            BIGINT UNSIGNED NOT NULL                COMMENT '지갑 ID',
    policy_id            BIGINT UNSIGNED NOT NULL                COMMENT '적립 당시 적용 정책',
    ...
    granted_by_admin_id  BIGINT UNSIGNED NULL                    COMMENT '수기지급 관리자. MANUAL일 때만',
...
CREATE TABLE point_usage (
    id               BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '사용 ID',
    wallet_id        BIGINT UNSIGNED NOT NULL                COMMENT '지갑 ID',
...
CREATE TABLE point_usage_line (
    id               BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '사용 라인 ID',
    usage_id         BIGINT UNSIGNED NOT NULL                COMMENT '사용 ID',
    earning_id       BIGINT UNSIGNED NOT NULL                COMMENT '차감 대상 적립건',
...
CREATE TABLE point_usage_cancellation (
    id               BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '사용취소 ID',
    usage_id         BIGINT UNSIGNED NOT NULL                COMMENT '원 사용건',
...
CREATE TABLE point_usage_cancellation_line (
    id                   BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '취소 라인 ID',
    cancellation_id      BIGINT UNSIGNED NOT NULL                COMMENT '사용취소 ID',
    usage_line_id        BIGINT UNSIGNED NOT NULL                COMMENT '복원 대상 원 사용 라인',
    restored_amount      BIGINT          NOT NULL                COMMENT '복원액',
    restore_type         VARCHAR(15)     NOT NULL                COMMENT 'RESTORED / RE_EARNED',
    reearned_earning_id  BIGINT UNSIGNED NULL                    COMMENT 'RE_EARNED 시 생성된 신규 적립건',
    created_at           DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at           DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
...
CREATE TABLE point_wallet_transaction (
    ...
    earning_id        BIGINT UNSIGNED NULL                    COMMENT 'EARN / EARN_CANCEL / EXPIRE',
    usage_id          BIGINT UNSIGNED NULL                    COMMENT 'USE',
    cancellation_id   BIGINT UNSIGNED NULL                    COMMENT 'USE_CANCEL',
